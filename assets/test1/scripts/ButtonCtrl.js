...
cc.Class({
    ...
    onLoad: function() {
        ...
        this.posShare = this.buttonShare.node.position.y;
    ...
    onBtnPlayClicked: function() {
        ...
        this.buttonShare.node.runAction(cc.sequence(cc.fadeOut(0.3), cc.delayTime(0.05), cc.moveBy(0.1, cc.v2(0, 480)), this.lobbyAppearAction));
    ...
    btnShow: function() {
        ...
        this.lobbyAppearAction = cc.moveTo(0.1, cc.v2(0, this.posShare));
        this.buttonShare.node.runAction(cc.sequence(cc.moveTo(0.1, cc.v2(0, this.posShare)), this.lobbyAppearAction, cc.fadeIn(0.3), cc.delayTime(0.05)));
